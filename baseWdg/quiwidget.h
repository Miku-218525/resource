...
public:
    ...
    static QChar IconPlus;          //加号图标
    static QChar IconSub;           //减号图标
    static QChar IconArrowRigh;     //向右箭头图标
    static QChar IconCaretRight;
    static QChar IconCaretLeft;     //向右箭头图标
    static QChar IconCaretUp;     //向右箭头图标
    static QChar IconCaretDown;     //向右箭头图标
    static QChar IconFastfoward;    //快进图标
    static QChar IconPlay;          //播放图标
    static QChar IconPause;          //播放图标
    static QChar IconRefresh;       //刷新图标
    static QChar IconChain;         //链接图标
    static QChar IconChainbroken;   //链接断开图标
